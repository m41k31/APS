...
public class EnderecosDAO {
	...
	public int create(Enderecos o) {
		...
		int codEndereco = 0;
		try {
			preparedStmt = con.prepareStatement("INSERT INTO enderecos (nr_cep, de_logradouro, nr_numero, de_complemento, de_bairro, de_estado, de_cidade, cd_pessoa) VALUES (?,?,?,?,?,?,?,?);", PreparedStatement.RETURN_GENERATED_KEYS);
			...
			preparedStmt.setInt(8, o.getCodigoPessoa());
	...
	public void delete(int id) {
		...
		PreparedStatement preparedStmt = null;
		try {
			preparedStmt = con.prepareStatement("DELETE FROM enderecos WHERE cd_pessoa = ?;");
	...
	public void update(Enderecos o) {
		...
		PreparedStatement preparedStmt = null;
		try {
			preparedStmt = con.prepareStatement("UPDATE enderecos SET nr_cep = ?, de_logradouro = ?, nr_numero = ?, de_complemento = ?, de_bairro = ?, de_estado = ?, de_cidade = ? WHERE cd_pessoa= ?;");
			preparedStmt.setString(1, o.getCep());
			preparedStmt.setString(2, o.getRua());
			preparedStmt.setString(3, o.getNumero());
			preparedStmt.setString(4, o.getComplemento());
